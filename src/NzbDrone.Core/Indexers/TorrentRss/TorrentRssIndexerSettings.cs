...
namespace NzbDrone.Core.Indexers.TorrentRss
{
    ...
    public class TorrentRssIndexerSettings : IProviderConfig
    {
        ...
        [FieldDefinition(2, Label = "Allow Zero Size", HelpText="Enabling this will allow you to use feeds that don't specify release size, but be careful, size related checks will not be performed.")]
